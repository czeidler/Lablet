...
public class FileChooserDialog extends Dialog implements FileChooser {
	...
	/**
	 * Creates a file chooser dialog which lists all the file of a particular a_file_dialog_folder.
	 * 
	 * @param context The current context.
	 * @param folderPath The a_file_dialog_folder which files are going to be listed.
	 */
