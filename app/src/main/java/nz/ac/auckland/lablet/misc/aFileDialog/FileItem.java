...
public class FileItem extends LinearLayout {
	...
	public void setFile(File file) {
		if(file != null) {
			...
			// Change the icon, depending if the file is a a_file_dialog_folder or not.
			this.updateIcon();
		}
	}
	...
	/**
	 * Updates the icon according to if the file is a a_file_dialog_folder and if it can be selected.
	 */
	private void updateIcon() {
		// Define the icon.
		int icon = R.drawable.a_file_dialog_document_gray;
		if(this.selectable) {
			icon = (this.file != null && file.isDirectory())? R.drawable.a_file_dialog_folder : R.drawable.a_file_dialog_document;
		}
		...
		if(icon != R.drawable.a_file_dialog_document_gray) {
