...
public class FileChooserLabels implements Serializable {
	...
	/**
	 * The label for the button used to create a file or a a_file_dialog_folder.
	 */
	public String labelAddButton;
	
	/**
	 * The label for the button for select the current a_file_dialog_folder (when using the file chooser for select folders).
	 */
	...
	/**
	 * The label for the 'a_file_dialog_no' button when confirming the selection o creation of a file.
	 */
