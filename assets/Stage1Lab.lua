function onBuildExperimentScript(scriptBuilder)
	...
	experimentAnalysisFreeFall:setDescriptionText("Please analyze the free fall video:")
	...
	experimentAnalysisUpDown:setDescriptionText("Please analyze the up down video:")
	...
	experimentAnalysisProjectile:setDescriptionText("Please analyze the projectile video:")

	-- analysis
	local calculateYSpeed = scriptBuilder:create("CalculateYSpeed")
	calculateYSpeed:setExperiment(experimentFreeFall)
	calculateYSpeed:setTitle("Estimating impact y-velocity and y-accelerations")
	...
	freeFallQuestions:addText("Complete the following questions and discuss with your demonstrator:")
	...
	upDownMotionQuestions:addPositionGraph(experimentUpDown, graphLayout)
	...
	projectileMotionQuestions:addQuestion("The position-time graphs and the velocity-time graphs are created from your measurements. Use these graphs to complete the questions below and discuss with your demonstrator.")
	...
	projectileMotionQuestions:addQuestion("Using the velocity-time graphs, estimate the horizontal and vertical accelerations and discuss with your demonstrator how you arrive at your estimates.")
	...
	projectileMotionQuestions:addQuestion("How do your estimates of horizontal and vertical accelerations compare with your expected values? Discuss with your demonstrator what your expected values are, and if there is any difference, discuss the sources of uncertainties.")
