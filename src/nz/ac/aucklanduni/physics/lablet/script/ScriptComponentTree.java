...
import nz.ac.aucklanduni.physics.lablet.misc.Hash;
 ...
 * component. A {@link nz.ac.aucklanduni.physics.lablet.script.ScriptComponentTree} has a link to its parent (if it exists).
 */
