...
public class FileChooserActivity extends Activity implements FileChooser {
	...
	/**
	 * The a_file_dialog_folder that the class opened by default.
	 */
	 ...
	 * path of the a_file_dialog_folder which files are going to be listed.
	 */
	...
	/**
	 * Constant used for represent the key of the bundle object (inside the start's intent) which contains  
	 * a boolean that indicates if the title must show the full path of the current's a_file_dialog_folder (true) or only
	 * the a_file_dialog_folder's name (false).
	 */
	public static final String INPUT_SHOW_FULL_PATH_IN_TITLE = "input_show_full_path_in_title";
	
	/**
	 * Constant used for represent the key of the bundle object (inside the start's intent) which contains  
	 * a boolean that indicates if the 'Back' button must be used to navigate to the parents a_file_dialog_folder (true) or
	 ...
	 * File object, that represents the file selected by the user or the a_file_dialog_folder in which the user wants to create
	 * a file. 
	 */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Load the files of a a_file_dialog_folder.
    ...
    public void onBackPressed() {
    	// Verify if the activity must be finished or if the parent a_file_dialog_folder must be opened.
